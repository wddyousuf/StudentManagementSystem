          ...
          <div class="row">
            ...
            <section class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('about.store') }}" method="post" id="myForm" name="addabout">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="about">Description</label>
                                <textarea id="about" value="{{ old('about') }}" class="form-control" name="about" rows="4" cols="15"></textarea>
                              </div>
                        </div>
                        <div>
