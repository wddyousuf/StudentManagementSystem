          ...
          <div class="row">
            ...
            <section class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('vision.store') }}" method="post" enctype="multipart/form-data" id="myForm" name="addvision">
                        @csrf
                        <div class="form-row">
                        ...
                        <div>
                            <input type="submit" value="Add Vision" class="btn btn-success">
                        </div>
                    </form>
                </div>
            </div>
