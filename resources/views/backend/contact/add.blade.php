          ...
          <div class="row">
            ...
            <section class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('contact.store') }}" method="post" id="myForm" name="addcontact">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="linked_in_link" id="linked_in_link" class="form-control" value="{{ old('linked_in_link') }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="gplus_link">Google+ Link</label>
                                <input type="text" name="gplus_link" id="gplus_link" class="form-control" value="{{ old('gplus_link') }}">
                            </div>
                        </div>
                        <div class="form-row">
